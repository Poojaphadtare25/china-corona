...
public class FirstAuomationTest {
	...
	public void begin()
	{
	report=new ExtentReports(".//report//CovidReport.html", true);
	report.addSystemInfo("Environment", "QA4");
	report.addSystemInfo("Author", "ramarao");
	report.addSystemInfo("UserStory", "US60621");
